...
- [`WorldForge_V6.5_实施安全并发与高分屏适配冻结最终工程设计文档.docx`](./WorldForge_V6.5_实施安全并发与高分屏适配冻结最终工程设计文档.docx)：产品、架构、功能、UI、安全、并发、高分屏和验收的完整冻结方案。
- [`WorldForge_Codex_全流程技术开发指南.md`](./WorldForge_Codex_全流程技术开发指南.md)：指导 Codex 从架构初始化到开发、测试、审查、验收和发布的完整执行文档。
- [`AGENTS.md`](./AGENTS.md)：Codex 仓库级强制执行规则。
- [`agent.md`](./agent.md)：兼容入口，以 `AGENTS.md` 为权威。

仓库不再保留拆分版设计文档或拆分版开发指南。
