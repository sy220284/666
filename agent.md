...
任何全量代码审计、功能审计、产品设计审计、体验审计、安全/恢复/发布审计、任务复审或PR审查，必须读取 `docs/process/USER_PERSPECTIVE_AUDIT_REPORTING.md`。
...
工程术语只能用于必要的代码定位或开发附录，禁止直接充当问题标题、用户影响或审计结论。严重程度统一使用“严重 / 高 / 中 / 低”，按真实作者使用后果判断。
