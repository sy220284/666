...
export const PROJECT_OPERATION_SEMANTICS = {
  ...
  [JOURNAL_COMMANDS.list]: 'query',
  [JOURNAL_COMMANDS.preview]: 'query',
  [JOURNAL_COMMANDS.generate]: 'mutation',
  [JOURNAL_COMMANDS.updateNote]: 'mutation',
  [JOURNAL_COMMANDS.updatePreferences]: 'mutation',
  [JOURNAL_COMMANDS.catchUp]: 'mutation',
  [JOURNAL_COMMANDS.markAiFailed]: 'mutation',
