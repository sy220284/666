...
- 每张用户功能任务同时完成最小可操作UI。
- M5-00在面向用户的AI生成入口前完成现有作者工作流体验收口；M7负责统一导航、状态、主题和响应式，不负责第一次接通业务。
...
M5-00是M5-01的硬依赖，负责在T0/T1界面接入前关闭现有作者工作流的P0体验缺口。
