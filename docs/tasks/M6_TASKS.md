...
| M6-05 | [DOCX安全导入与多格式导出](M6/M6-05_DOCX_TRANSFER.md) | M1-09、M1-08、M6-04 | 扩展现有导入协调器，补齐DOCX安全导入和TXT/Markdown/DOCX Version导出，并复用Core决定的`import`来源。 |
...
- M6-04未完成前不得激活M6-05，DOCX不得建立独立来源枚举。
