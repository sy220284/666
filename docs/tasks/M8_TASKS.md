...
| M8-06 | [发布资格与任务治理硬化](M8/M8-06_RELEASE_QUALIFICATION_GOVERNANCE.md) | M8-05 | 动态发布资格、最终验证保持、延期账本与受检提交可达性 | Verified |
| M8-07 | [中文作者体验治理闭环与产品发布验收硬化](M8/M8-07_CHINESE_EXPERIENCE_GOVERNANCE.md) | M8-06 | 正式术语、作者错误、深色与响应式、真实输入法、机器验收和发布门绑定 | In Progress |
...
M8-04、M8-05与M8-06保持Verified。2026-07-30全量审计确认中文术语、错误展示、深色主题、响应式布局、真实输入法和产品验收发布绑定仍有开放缺口，M8-07已独立立项并进入In Progress。M8-07完成前发布资格必须保持阻断。
...
- 当前活动状态只从`ACTIVE_TASK.json`读取；M8-07必须在唯一正式分支和唯一正式PR内完成受控合并与治理关闭。
