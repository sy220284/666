...
| M4   | 检索与AI基础设施     |      5 | 建立FTS、约束包、Provider、生产Prompt和GenerationRun等可复用AI基础设施。                      |
| M5   | AI生成与候选审阅     |      7 | 先完成作者体验门，再完成T0/T1、改写、融合、候选审阅和真实状态提取闭环。                       |
| M6   | 校验、搜索与交付     |      6 | 补齐校验、全项目搜索、人工写作统计、节奏指标、DOCX和三轨备份恢复。                            |
| M7   | 完整UI与体验整合     |      3 | 在M5基础骨架上完成向导、全功能工作台接入、主题、无障碍和目标显示环境终验。                    |
| M8   | 发布硬化与验收       |      3 | 完成安全、数据、AI边界、性能、E2E、跨平台构建、P0追踪和发布关闭。                             |
...
| M4-04 | [`Prompt Registry、输出Schema与Cleaner`](M4/M4-04_PROMPT_REGISTRY_OUTPUT.md)   | M4-02、M4-03、M0-07          | In Progress     |
...
| M5-01 | [`T0多候选骨架`](M5/M5-01_T0_SKELETON.md)                                                   | M5-00、M4-05                       | Planned |
...
| M5-06 | [`真实状态提取与StateProposal接入`](M5/M5-06_STATE_EXTRACTION_PROPOSAL_INTEGRATION.md)       | M5-05、M3-06                       | Planned |
...
| ID    | 任务卡                                                                          | 依赖              | 状态    |
| ----- | ------------------------------------------------------------------------------- | ----------------- | ------- |
| M7-01 | [`新手/专业模式、向导与三条创作路径`](M7/M7-01_ONBOARDING_MODES_PATHS.md)       | M1—M6、M5-00      | Planned |
| M7-02 | [`统一工作台、沉浸视图与交互状态`](M7/M7-02_UNIFIED_WORKBENCH_INTERACTIONS.md)  | M7-01、M6         | Planned |
...
4. 每个用户功能任务必须包含最小可操作UI；M3-07—M3-10先完成Renderer正式架构迁移，M5-00在AI生成前完成作者工作流收口，M7只做向导与全功能整合，不负责基础框架重写。
5. 恢复点、FTS、Candidate、Prompt、TaskProtocol、导入协调器和RecoveryService等公共能力分为基础底座和上层使用，禁止重复实现。
