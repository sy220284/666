...
| M4-02 | [`P0—P4约束包与裁剪追溯`](M4/M4-02_CONSTRAINT_PACKAGE.md)                      | M4-01、M3-06            | In Progress |
...
4. 每个用户功能任务必须包含最小可操作UI；M3-07—M3-10先完成Renderer正式架构迁移，M5-00在AI生成前完成作者工作流收口，M7只做统一整合，不负责基础框架重写或第一次接通业务。
...
8. M5-00未Verified前，不得激活M5-01或新增面向用户的AI生成入口。
