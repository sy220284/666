...
export function assertChapter(connection: DatabaseSync, projectId: string, chapterId: string): void {
  chapterPosition(connection, projectId, chapterId);
}

export function assertCharacter(connection: DatabaseSync, projectId: string, characterId: string): void {
