...
function invokeAbortListener(listener: EventListenerOrEventListenerObject, signal: AbortSignal): void {
...
export function createReplayableAbortBoundary(
  parentSignal?: AbortSignal,
): ReplayableAbortBoundary {
