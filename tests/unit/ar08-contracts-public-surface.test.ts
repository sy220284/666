...
const APPROVED_RUNTIME_EXPORT_ADDITIONS = [
  ...
  'StoryCommentTagSchema',
  'StoryDigestFreshnessSchema',
  'StoryDigestGenerationSourceSchema',
  ...
  'StyleMetricSchema',
  'StyleProfileSceneMappingSchema',
  'StyleProfileSchema',
  'ThemeSealTextSchema',
